...
INSERT IGNORE INTO
    lookup_abreviaturas (abr, abr_correta)
VALUES ('L.D.A.', 'LDA');
...
-- ENTIDADES
INSERT IGNORE INTO
    entidades_ext (id_entidade, nif, nome, pais)
VALUES (
        246088,
        '600077594',
...
VALUES (
        3673,
        '-',
        'Armando Peixoto de Sousa_Eurodidacta',
        'Portugal'
    );
...
VALUES (
        5649363,
        '-',
        'Maria de Fátima Lopes da Costa Alves',
        'Portugal'
    );
...
VALUES (
        5649364,
        '-',
        'Maria José dos Santos Azevedo Campainha Viana',
        'Portugal'
    );
...
VALUES (
        2691653,
        '513843116',
        'Transfodinamica Serviços para Eventos Unipessoal LDA',
        'Portugal'
    );
...
VALUES (
        1037,
        '500025517',
        'Sinop - António Moreira dos Santos, SA',
        'Portugal'
    );
...
VALUES (
        312496,
        '509872069',
        'ASSOCIAÇÃO PORTUGAL A MAO - Centro de Estudos e Promoção das Artes e Ofícios Portugueses',
        'Portugal'
    );
...
VALUES (
        ...
        'Portugal,Faro,Vila Real Sto Antonio'
    );
...
VALUES (
        3340227,
        '515091944',
        'Paulo Costa Garcia Unipessoal Lda',
        'Portugal'
    );
...
VALUES (
        133401,
        '503576689',
        'S.C.P.R. - Sociedade de Construção, Projetos e Reabilitação, Lda.',
        'Portugal'
    );
...
VALUES (
        144857,
        '504689878',
        'CEIIA - Centro Exc. Inov. Ind. Automovel',
...
VALUES (
        11094,
        '502764406',
        'Mbit - Computadores e Serviços de Informática SA',
        'Portugal'
    );
...
VALUES (
        637849,
        '513154990',
        'Configbit - Soluções Tecnológicas, Unipessoal, Lda.',
        'Portugal'
    );
...
VALUES (
        2079826,
        '514360194',
        'Megabarcelos - informática e tecnologia Unip.,Lda',
        'Portugal'
    );
...
VALUES (
        2342983,
        '514665637',
        'MIXINFOR - SISTEMAS INFORMÁTICOS, UNIPESSOAL LDA',
        'Portugal'
    );
...
VALUES (
        4746226,
        '508194369',
        'SOLUÇÕES BRILHANTES - EQUIPAMENTOS INFORMÁTICOS E RECICLAGEM UNIPESSOAL LDA',
        'Portugal'
    );
...
VALUES (
        11391,
        '501461396',
        'Protecnil - Sociedade Técnica de Construções, SA',
        'Portugal'
    );
...
VALUES (
        5147433,
        '518603210',
        'Pateo Marafado Associação Artistica e Cultural',
        'Portugal'
    );
...
VALUES (
        ...
        'Consulta Prévia',
        'AQUISIÇÃO DE MATERIAL DIDÁTICO - Pré-escolar e 1.º ciclo.',
        'AQUISIÇÃO DE MATERIAL DIDÁTICO - Pré-escolar e 1.º ciclo.',
        '[{"nif": "600077594", "id": 246088, "description": "Agrupamento de Escolas Alberto Sampaio, Braga"}]',
        '28-04-2026',
        '28-04-2026',
        '4.404,08 €',
        '39162110-9',
        ...
        'Artigo 95.º, n.º 1, a), contrato de locação ou de aquisição de bens móveis ou de aquisição de serviços cujo preço contratual não excede 10.000,00 € e para Região Autónoma da Madeira um coeficiente de 1,45 €',
        NULL,
        '0',
        NULL,
        '[{"nif": "-", "id": 3673, "description": "Armando Peixoto de Sousa_Eurodidacta"}]',
        'https://community.vortal.biz/Public/public-tender-documents/Z08vSHBudVVMZ3N2blY2dTEybHZKN05UeFp2Mzlpd2JQQVp5QXY3K09PQ08vdlN3V3graXJaVTk5T05zeUFYR0pZOC9PVEpsRmlWbkNFVlM5WlFFcFE9PXoobFVX',
        NULL,
        '0',
        'Não aplicável'
    );
...
VALUES (
        ...
        'Consulta Prévia',
        'Aquisição de serviços em regime de tarefa, para limpeza das ruas e jardinagem dos espaços verdes da Freguesia de Darque',
        'Aquisição de serviços em regime de tarefa, para limpeza das ruas e jardinagem dos espaços verdes da Freguesia de Darque',
        '[{"nif": "501065962", "id": 38215, "description": "Freguesia de Darque"}]',
        '28-04-2026',
        '16-04-2026',
        '23.820,00 €',
        '90611000-3',
        'Serviços de limpeza de ruas',
        '1006 dias',
        ...
        NULL,
        NULL,
        'Código dos Contratos Públicos (DL111-B/2017) e Lei n.º 30/2021, de 21.05',
        '',
        NULL,
        '0',
        '[{"nif": "-", "id": 5649363, "description": "Maria de Fátima Lopes da Costa Alves"}, {"nif": "-", "id": 5649364, "description": "Maria José dos Santos Azevedo Campainha Viana"}, {"nif": "-", "id": 5649362, "description": "Margarida Amorim Soares"}]',
        '[{"nif": "-", "id": 5649363, "description": "Maria de Fátima Lopes da Costa Alves"}]',
        NULL,
        NULL,
        '0',
        'Não aplicável'
...
VALUES (
        ...
        'Aquisição de serviços',
        'Consulta Prévia',
        'Operação/Manutenção de ETAR e EEAR 2026',
        'Operação/Manutenção de ETAR e EEAR 2026',
        '[{"nif": "515957631", "id": 3934357, "description": "Águas Públicas da Serra da Estrela, EIM, SA"}]',
        '28-04-2026',
        '17-04-2026',
        '24.000,00 €',
        '90400000-1',
        ...
        NULL,
        '0',
        '[{"nif": "510122639", "id": 412578, "description": "AGR - Engenharia e Serviços, Lda"}]',
        '[{"nif": "510122639", "id": 412578, "description": "AGR - Engenharia e Serviços, Lda"}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA3NDA0OQ',
        NULL,
        '0',
        'Não aplicável'
    );
...
VALUES (
        ...
        NULL,
        '0',
        '[{"nif": "500838909", "id": 38764, "description": "Camacho Engenharia, S. A."}]',
        '[{"nif": "500838909", "id": 38764, "description": "Camacho Engenharia, S. A."}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA3NDA5Ng',
        NULL,
        '0',
...
VALUES (
        ...
        'Aquisição de serviços',
        'Ajuste Direto Regime Geral',
        'Aquisição de Serviços para Montagem de Estruturas e Organização Logística - "Feira de Maio 2026"',
        'Aquisição de Serviços para Montagem de Estruturas e Organização Logística - "Feira de Maio 2026"',
        '[{"nif": "501091823", "id": 1445, "description": "Município de Felgueiras"}]',
        '28-04-2026',
        '28-04-2026',
        '10.000,00 €',
        '79952000-2',
        ...
        NULL,
        'Código dos Contratos Públicos (DL111-B/2017) e Lei n.º 30/2021, de 21.05',
        'Artigo 95.º, n.º 1, c), locação ou aquisição de bens móveis ou de serviços nos termos das alíneas i),ii),iii),cumulativamente',
        NULL,
        '0',
        '[{"nif": "513843116", "id": 2691653, "description": "TRANSFODINAMICA SERVIÇOS PARA EVENTOS, UNIPESSOAL LDA"}]',
        '[{"nif": "513843116", "id": 2691653, "description": "Transfodinamica Serviços para Eventos Unipessoal LDA"}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA4NzIzOA',
        NULL,
        '0',
        'ausência de recursos próprios'
    );
...
VALUES (
        ...
        'Empreitadas de obras públicas',
        'Consulta Prévia',
        'Substituição do lajeado de granito danificado na Praça Dr. José Vieira de Carvalho, na freguesia da Cidade da Maia',
        'Substituição do lajeado de granito danificado na Praça Dr. José Vieira de Carvalho, na freguesia da Cidade da Maia',
        '[{"nif": "505387131", "id": 175, "description": "Município da Maia"}]',
        '28-04-2026',
        '27-03-2026',
        '39.997,75 €',
        '45262510-9',
        ...
        NULL,
        '0',
        '[{"nif": "507701348", "id": 10067, "description": "Joaquim Coelho da Silva, S.A."}, {"nif": "500025517", "id": 1037, "description": "Sinop - António Moreira dos Santos, SA"}]',
        '[{"nif": "507701348", "id": 10067, "description": "Joaquim Coelho da Silva, S.A."}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTAwMjk4Mg',
        NULL,
        '0',
        'Não aplicável'
    );
...
VALUES (
        ...
        'Aquisição de serviços',
        'Consulta Prévia',
        'Aluguer camarins e sanitários 25 Abril',
        'Aluguer camarins e sanitários 25 Abril',
        '[{"nif": "506173968", "id": 3230, "description": "Município do Seixal"}]',
        '28-04-2026',
        '23-04-2026',
        '10.565,00 €',
        '79952000-2',
        ...
        NULL,
        '0',
        '[{"nif": "508190495", "id": 13319, "description": "ALUGAL, LDA."}]',
        '[{"nif": "508190495", "id": 13319, "description": "Alugal, Lda"}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA3NzA4Mw',
        NULL,
        '0',
        'Não aplicável'
    );
...
VALUES (
        ...
        'Aquisição de serviços',
        'Ajuste Direto Regime Geral',
        'Serviços para candidatar o Bordado de Castelo Branco à Inscrição na Lista Representativa do Património Cultural Imaterial da Humanidade  UNESCO.',
        'Serviços para candidatar o Bordado de Castelo Branco à Inscrição na Lista Representativa do Património Cultural Imaterial da Humanidade  UNESCO.',
        '[{"nif": "501143530", "id": 3477, "description": "Município de Castelo Branco"}]',
        '28-04-2026',
        '28-04-2026',
        '19.850,00 €',
        '75112100-5',
        'Serviços administrativos relacionados com projectos de desenvolvimento',
        '365 dias',
        'Portugal',
        'Artigo 20.º, n.º 1, alínea d) do Código dos Contratos Públicos',
        '0',
        ...
        NULL,
        '0',
        '[{"nif": "509872069", "id": 312496, "description": "Associação Portugal à mão - Centro de Estudos e Promoção das Artes e Ofícios Portugueses"}]',
        '[{"nif": "509872069", "id": 312496, "description": "ASSOCIAÇÃO PORTUGAL A MAO - Centro de Estudos e Promoção das Artes e Ofícios Portugueses"}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA2NzI4OA',
        NULL,
        '0',
        'ausência de recursos próprios'
    );
...
VALUES (
        ...
        'Aquisição de serviços',
        'Ajuste Direto Regime Geral',
        'Prestação de Serviços, na Modalidade de Avença, para motorista de veículos pesados de passageiros',
        'Prestação de Serviços, na Modalidade de Avença, para motorista de veículos pesados de passageiros',
        '[{"nif": "506833224", "id": 1265, "description": "Município de Vila Real de Santo António"}]',
        '28-04-2026',
        '28-04-2026',
        '10.800,00 €',
        '75100000-7',
        'Serviços relacionados com a administração pública',
        '247 dias',
        'Portugal',
        'Artigo 20.º, n.º 1, alínea d) do Código dos Contratos Públicos',
        '0',
        ...
        NULL,
        '0',
        '[{"nif": "-", "id": 5123533, "description": "Sónia Maria Branco Fernandes"}]',
        '[{"nif": "-", "id": 5123533, "description": "Sónia Maria Branco Fernandes"}]',
        'https://www.acingov.pt/acingovprod/2/zonaPublica/zona_publica_c/donwloadProcedurePiece/MTA3NzE0Ng',
        NULL,
        '0',
        'ausência de recursos próprios'
    );